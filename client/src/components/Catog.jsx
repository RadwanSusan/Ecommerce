...
const Catog = ({ item }) => {
  ...
  let inputCatog = document.getElementsByClassName(
    "block_quantity__number2"
  )[0];
  let idProduct;
...
//   };
	document.querySelectorAll(".towishlist").forEach((ele) => { 
		ele.addEventListener("click", (e) => {
			console.log(ele.parentNode.firstChild.firstChild); 
			console.log(ele.parentNode.firstChild.lastChild); 

			if (ele.parentNode.firstChild.firstChild.style.visibility == "hidden") {
        ele.parentNode.firstChild.firstChild.style.visibility = "visible";
        ele.parentNode.firstChild.lastChild.style.visibility = "hidden";
      }
                                        ...
                                        <div className="product actions product-item-actions">
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              <BsHeart className="add-to-wish" />

                                              <span>Add to Wish List</span>
                                            </div>
                                            <div className="action tocompare">
                                              <IoGitCompareOutline />
