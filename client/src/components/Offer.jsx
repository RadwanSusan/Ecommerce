                    ...
                    <div className='owl-stage-outer'>
                      ...
                      >
                        {Object.keys(offer).map(function (data) {
                          {/* let timeStart = offer[data]['timeStart']?.split('-');
                          if (!timeStart) {
                            return;
                          }
                          timeStart = timeStart?.map(Number);
                          let timeEnd = offer[data]['timeEnd']?.split('-');
                          if (!timeEnd) {
                            return;
                          }
                          timeEnd = timeEnd?.map(Number);
                          ...
                          if (
                            fullDate[0] < timeStart[0] &&
                            fullDate[0] > timeEnd[0]
                          ) {
                            return;
                          } else if (
                            fullDate[1] < timeStart[1] &&
                            fullDate[1] > timeEnd[1]
                          ) {
                            return;
                          } else if (
                            fullDate[2] < timeStart[2] &&
                            fullDate[2] > timeEnd[2]
                          ) {
                            return;
                          } else { */}
